...
Once the `conda-forge` channel has been enabled, `pytorch_geometric` can be installed with:

```
conda install pytorch_geometric
```

It is possible to list all of the versions of `pytorch_geometric` available on your platform with:
